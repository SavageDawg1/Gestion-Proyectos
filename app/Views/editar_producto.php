    ...
    <div class="auth-box product-auth-box">
        ...
        <form action="editar_producto.php?id=<?php echo $id_producto; ?>" method="POST" class="product-auth-form" data-dirty-guard data-product-form data-product-id="<?php echo (int) $id_producto; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="categoria_nombre" name="categoria_nombre" list="categorias_disponibles" placeholder="Escribe o selecciona una categoria" autocomplete="off" value="<?php echo htmlspecialchars($categoriaActualNombre); ?>">
